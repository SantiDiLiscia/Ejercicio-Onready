...
class Auto extends Vehiculo {
  ...
  // para determinar el orden de la iteracion en los for/of
  *[Symbol.iterator](){
    yield 'marca'
    yield 'modelo'
    yield 'puertas'
...
class Concesionaria {
  ...
  ordenadosPorPrecio(){
    let ordenados = this.vehiculos.sort((x,y) => y._precio - x._precio)
    let resultado = []
    ordenados.forEach(e => resultado.push(`${e.marca} ${e.modelo}`))
